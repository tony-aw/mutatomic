...
#' is handled by the 'mutatomic' package. \cr
#' \cr
...
#' All functions/methods in the 'mutatomic' package
#' (and 'data.table', 'squarebrackets', 'broadcast', and more)
...
#' \cr
#' First, the coercion rules are slightly different: see \link{mutatomic_coercion}. \cr
#' \cr
...
#' which is a mutable data.frame class, and supported by 'mutatomic'. \cr
#' Similarly, 'mutatomic' adds a class for mutable atomic objects: \cr
...
#' `ma_set(1:10, ...)`, `ma_set(x$a, ...)`, or `ma_set(base::letters)`, \cr
...
#' To ensure an object cannot be modified by any of the methods/functions from 'mutatomic',
...
#' 'mutatomic' protects the user from do something like the following:
#' 
#' ```{r eval = FALSE}
#' 
...
#' 
#' 
#' @example inst/examples/aaa_mutatomic_PassByReference.R
#' 
#' 
#' @rdname aaa01_mutatomic_PassByReference
#' @name aaa01_mutatomic_PassByReference
#' @aliases mutatomic_PassByReference
NULL
