...
#' Regular lists are treated as immutable by 'mutatomic'. \cr
...
#' Notice also that \link{ma_set}`(x$a, ...)` will not work. \cr
...
#' 
#' 
#' @example inst/examples/aaa_mutatomic_coercion.R
#' 
#' 

#' @rdname aaa02_mutatomic_coercion
#' @name aaa02_mutatomic_coercion
#' @aliases mutatomic_coercion
NULL
