#' Apply Functions Over mutatomic Matrix Margins By Reference
#'
#' @description
#' The `setapply()` function
#' applies a functions over the rows or columns of a 
#' \link{mutatomic} matrix,
#' through \link[=mutatomic_PassByReference]{pass-by-reference semantics}. \cr
#' \cr
#' The `setapply()` is a bit faster and uses less memory than \link[base]{apply}. \cr \cr
#' 
#' 
#' @param x a \link{mutatomic} 2-dimensional array (i.e. a matrix). \cr
